...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.15.7/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.15.7/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
