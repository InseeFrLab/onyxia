...
helm install onyxia onyxia/onyxia --version "8.16.6" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v8.16.6/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.23.7/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.23.7/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
