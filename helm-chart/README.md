...
helm install onyxia onyxia/onyxia --version "7.2.0" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v7.2.0/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.2.0/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.2.0/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
