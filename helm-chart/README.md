...
helm install onyxia onyxia/onyxia --version "9.2.1" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v9.2.1/keycloak-theme.jar
    volumeMounts:
      - name: extensions
