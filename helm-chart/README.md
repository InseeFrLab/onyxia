...
helm install onyxia onyxia/onyxia --version "10.2.0" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v10.2.0/keycloak-theme.jar
    volumeMounts:
      - name: extensions
