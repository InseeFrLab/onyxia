...
helm install onyxia onyxia/onyxia --version "10.8.1" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v10.8.1/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.39.1/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.39.1/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
