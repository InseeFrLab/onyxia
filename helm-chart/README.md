...
helm install onyxia onyxia/onyxia --version "10.30.11" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v10.30.11/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.56.17/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.56.17/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
