...
helm install onyxia onyxia/onyxia --version "5.1.0" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v5.1.0/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
-   [The REST API (`api`)](https://github.com/InseeFrLab/onyxia-api/blob/v1.0.1/README.md#configuration)
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v3.1.0/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v3.1.0/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
