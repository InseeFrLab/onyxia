...
helm install onyxia onyxia/onyxia --version "11.5.2" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v11.5.2/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v5.5.2/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
