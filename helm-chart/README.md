...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v5.0.0/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v5.0.0/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
