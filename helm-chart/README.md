...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.16.2/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.16.2/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
