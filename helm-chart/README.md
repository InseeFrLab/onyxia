...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v3.0.1/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v3.0.1/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
