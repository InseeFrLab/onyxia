...
helm install onyxia onyxia/onyxia --version "4.1.4" -f onyxia-values.yaml
```
...
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/v4.1.4/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/v4.1.4/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
