...
helm install onyxia onyxia/onyxia --version "8.21.2" -f onyxia-values.yaml
```
...
extraInitContainers: |
  - name: realm-ext-provider
    ...
    args:
      - -c
      - |
        curl -L -f -S -o /extensions/onyxia.jar https://github.com/InseeFrLab/onyxia/releases/download/v8.21.2/keycloak-theme.jar
    volumeMounts:
      - name: extensions
...
-   [The REST API (`api`)](https://github.com/InseeFrLab/onyxia-api/blob/v2.6.0/README.md#configuration)
-   [The Web Application (`web`)](https://github.com/InseeFrLab/onyxia/blob/web-v4.28.2/web/.env)
...
[`values.schema.json` `"x-onyxia"` specifications](https://github.com/InseeFrLab/onyxia/blob/web-v4.28.2/web/src/core/ports/OnyxiaApi/XOnyxia.ts)
