...
echo "window._env_['SALON_CHAT'] = '$SALON_CHAT';" >> /usr/share/nginx/html/env-config.js
...
echo "window._env_['ONYXIA_CHAT'] = '$ONYXIA_CHAT';" >> /usr/share/nginx/html/env-config.js
