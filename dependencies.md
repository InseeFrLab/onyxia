...
We try, whenever we see an opportunity for it, to publish as standalone NPM module chunks of the code we write for Onyxia-web.  If help gets the complexity in checks. We use TS-CI as a starter for everything we publish on NPM.
