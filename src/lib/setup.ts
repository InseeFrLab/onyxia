...
} from "./secondaryAdapters/vaultSecretsManagerClient";
        ...
        switch (secretsManagerClientConfig.implementation) {
            ...
            case "VAULT": {
                const params: Parameters<typeof createVaultSecretsManagerClient>[0] = {
                    ...secretsManagerClientConfig,
                    "evtOidcAccessToken": oidcClient.evtOidcTokens.pipe(oidcTokens => [
        ...
        ...getMiddleware({
            "dependencies": {
                "secretsManagerClient":
                    ...
                    >(),
                "evtVaultToken":
                    createObjectThatThrowsIfAccessed<Dependencies["evtVaultToken"]>(),
                oidcClient,
                onyxiaApiClient,
            },
        }),
            ...
            "appConstants": await (async () => {
                const _common: appConstantsUseCase.AppConstant._Common = {
                    "vaultClientConfig": (() => {
                        switch (secretsManagerClientConfig.implementation) {
                            case "VAULT":
                                return secretsManagerClientConfig;
                            case "LOCAL STORAGE":
                                return {
                                    "baseUri": "",
                                    "engine": "",
                    ...
                    "keycloakConfig": (() => {
                        switch (oidcClientConfig.implementation) {
                            ...
                            case "KEYCLOAK":
                                return oidcClientConfig.keycloakConfig;
                        }
                    })(),
                };
