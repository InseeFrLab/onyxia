...
>()(
    { languages, fallbackLanguage },
    {
        ...
        "zh-CN": {
            ...
            "AccountK8sTab": {
                "kubernetes section title": undefined,
                "kubernetes section helper": undefined,
                "automatic script section helper": undefined,
                "automatic script section title": undefined,
                "valid until": ({ when }) => `在 ${when} 前有效`,
                "k8s server url": undefined,
