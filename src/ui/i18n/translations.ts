...
export const resources = id<Record<Language, Translations>>({
    ...
    "zh-CN": {
        ...
        "Home": {
            ...
            "subtitle": "使用 Python 或 R 并享受您需要的所有计算能力!",
            "cardTitle1": "灵活的工作环境和按需分配的服务",
            "cardTitle2": "一个为您服务的，活跃的和热情的社区",
            "cardTitle3": "快速、灵活、在线的数据存储空间",
            "cardText1":
                "分析数据、执行分布式计算并使用大量数据服务. 可以预订您需要的超大计算能力",
            "cardText2": "充分利用向您提供的资源: 教程, 培训和交流渠道.",
            "cardText3": "轻松访问您的数据以及您的程序提供给您的数据 - S3 API",
            "cardButton1": "查阅目录",
            "cardButton2": "加入社区",
            "cardButton3": "查看数据",
        },
        ...
        "CatalogExplorerCards": {
            ...
            "no result found": "没有找到关于 {{forWhat}} 的结果",
            "check spelling": "检查服务名称是否正确拼写或尝试扩大您的搜索范围",
            "go back": "返回主要服务",
            "main services": "主要服务",
            "all services": "所有服务",
            "search results": "搜索结果",
        ...
        "Catalog": {
            ...
            "contribute to the catalog": "为目录 {{catalogName}} 做贡献",
            "contribute to the package": "访问源包 {{packageName}} ",
            "here": "此处",
        },
        "CatalogLauncher": {
