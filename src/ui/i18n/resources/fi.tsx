...
export const translations: Translations<"fi"> = {
  "Account": {
    ...
    "personal tokens tooltip": "Sinulle generoidut salasanat, joilla on määritelty voimassaoloaika",
    "vault": "Vault"
  },
  "AccountInfoTab": {
  ...
  "AccountIntegrationsTab": {
    ...
    "third party tokens section title":
      "Yhdistä Gitlab-, Github- ja Kaggle-tilisi",
    "third party tokens section helper": `
            ...
            `,
    "personal token": ({ serviceName }) => `${serviceName}-henkilökohtainen pääsykoodi`,
    "link for token creation": ({ serviceName }) =>
      `Luo ${serviceName}-pääsykoodejasi.`,
    "accessible as env":
      "Käytettävissä palveluissasi ympäristömuuttujana"
  },
  "AccountStorageTab": {
    ...
    "accessible as env":
      "Käytettävissä palveluissasi ympäristömuuttujana:",
    "init script section title": "Pääsy tallennustilaan datalab-palveluiden ulkopuolelta",
  ...
  "AccountUserInterfaceTab": {
    ...
    "beta mode helper": "Edistyneitä alustan konfigurointeja ja ominaisuuksia varten.",
  ...
  "MyFiles": {
    ...
    "what this page is used for - my files": "Täällä voit selata S3 Bucket -tiedostojasi.",
  ...
  "SecretsExplorer": {
    ...
    "deletion dialog body": ({
      deleteWhat
    }) => `Olet poistamassa ${deleteWhat}.
            Tätä toimintoa ei voi peruuttaa.`,
    "already a directory with this name":
      "Tämän niminen hakemisto on jo olemassa",
  ...
  "App": {
    ...
    "divider: onyxia instance specific features": "Onyxia-instanssin erityisominaisuudet"
  },
  "Page404": {
  ...
  "Home": {
    ...
    "login": "Kirjaudu sisään",
    "subtitle": "Työskentele Pythonin tai R:n kanssa ja nauti tarvitsemastasi laskentatehosta!",
  ...
  "Catalog": {
    ...
    "header text2": "Selaa, käynnistä ja määritä palveluita muutamalla napsautuksella.",
  ...
  "CatalogLauncher": {
    ...
    "cancel": "Peruuta",
    "replace": "Korvaa se",
    "sensitive configuration dialog title": "Palvelun käynnistäminen voi olla vaarallista",
  ...
  "MyServices": {
    ...
    "confirm delete subtitle": "Varmista, että palvelusi ovat valmiita poistettaviksi",
  ...
  "MyServicesCards": {
    ...
    "everything have been printed to the console":
      "Kaikki on tulostettu konsoliin",
