...
export const regions: Get_Public_Configuration["regions"] = [
    {
        ...
        "name": "DG Insee",
        "description":
            "Region principale. Plateforme hébergée sur les serveurs de la direction générale de l'INSEE",
        "location": {
            "lat": 48.8164,
        ...
        "data": {
            "S3": {
                "monitoring": {
                    "URLPattern":
                        "https://grafana.lab.sspcloud.fr/d/PhCwEJkMz/minio-user?orgId=1&var-username=$bucketId",
                },
    ...
    },
    {
        ...
        "name": "Google cloud",
        "description":
            "Region de test. Aucune garantie de service. A n'utiliser que pour des tests.",
        "location": {
            "lat": 50.8503,
