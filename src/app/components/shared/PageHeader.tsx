...
const useStyles = makeStyles<{ helperHeight: number }>()((theme, { helperHeight }) => ({
    "root": {
...
export const PageHeader = memo((props: Props) => {
    const { mainIcon, title, helpTitle, helpIcon, helpContent, className } = props;
    ...
    return (
        <div className={cx(classes.root, className)}>
            <Text typo="page heading" className={classes.title}>
                <Icon iconId={mainIcon} className={classes.titleIcon} size="large" />
                {title}
            </Text>
            {isHelpShown && (
                <div ref={helperRef} className={classes.helperRoot}>
                    {helpIcon && (
                        <div>
                            <Icon iconId={helpIcon} className={classes.helperIcon} />
                        </div>
                    )}
