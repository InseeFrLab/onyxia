...
export const resources = id<Record<SupportedLanguage, Translations>>({
    "en": {
        ...
        "AccountIntegrationsTab": {
            ...
            "third party tokens section helper": `Connect your services to external accounts using 
    ...
    "fr": {
        ...
        "AccountUserInterfaceTab": {
            ...
            "enable beta": "Activer le mode béta-testeur",
             "beta helper": "Pour des configurations et fonctionnalités avancées de la plateforme.",
        },
        "AccountField": {
        ...
        "LeftBar": {
            ...
            "home": "Accueil",
            "account": "Mon compte",
            "catalogNew": "Catalogue de services",
