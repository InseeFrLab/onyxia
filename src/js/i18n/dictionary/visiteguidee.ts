const dictionary = {
	...
	guidedTourVignette7Text1: {
		...
		en:
			'Your self service is in progress. You can see the status on you personal lab. ',
	},
	...
	guidedTourVignette12Text2: {
		fr:
			...
			'et de le supprimer.',
		en:
			'Action buttons allow you to control the state of your service and to shut it down.',
	},
	guidedTourClosing: {
