...
export const translations: Translations<"fr"> = {
    ...
    S3Explorer: {
        ...
        "no profile title": "Connectez votre stockage objet",
        "no profile description":
            "Créez un profil S3 pour vous connecter à votre stockage et parcourir vos fichiers.",
    ...
    S3FileRequest: {
        ...
        "page description":
            "Une personne a partagé ce lien sécurisé afin que vous puissiez envoyer des fichiers directement dans son espace de stockage. Aucun compte Onyxia n’est nécessaire.",
        ...
        "privacy note": "Seuls les fichiers que vous choisissez sont envoyés via ce lien."
    },
    ...
    S3ExplorerMainView: {
        ...
        "CORS error description": ({ bucket, origin }) =>
            `Impossible d’accéder au bucket « ${bucket} » depuis ${origin}. La politique CORS du bucket n’autorise peut-être pas les requêtes provenant de ce site. Modifiez la configuration CORS S3 pour autoriser cette origine, puis réessayez.`,
        ...
        "no objects found description": ({ s3UriStr }) =>
            `Aucun objet n'a une clé qui commence par "${s3UriStr}".`,
    ...
    S3SharePrefixDialog: {
        ...
        "public sharing note":
            "Toute personne disposant de ce lien peut ouvrir ce dossier, même sans compte. Ce lien est disponible car ce dossier ou l'un de ses descendants a été rendu public."
    },
    S3ProfileDialog: {
