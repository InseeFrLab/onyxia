...
export function formatDuration(params: {
    ...
    t: DurationTranslationFunction | undefined;
}): string {
    const { durationSeconds, t = englishDurationFormatter } = params;
...
const englishDurationFormatter: DurationTranslationFunction = (key, params) => {
    const en = {
        singular: {
            second: "1 second",
            minute: "1 minute",
