...
const createOctokit_1 = __nccwpck_require__(6605);
...
function _run(params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const previousReleaseTag = yield (() => __awaiter(this, void 0, void 0, function* () {
            const octokit = (0, createOctokit_1.createOctokit)({ github_token });
            const { getLatestSemVersionedTag } = (0, getLatestSemVersionedTag_1.getLatestSemVersionedTagFactory)({ octokit });
            const resp = yield getLatestSemVersionedTag({
                owner,
                repo,
...
function setOutputFactory() {
    function setOutput(outputs) {
        (0, objectKeys_1.objectKeys)(outputs)
...
const listTags_1 = __nccwpck_require__(1566);
const SemVer_1 = __nccwpck_require__(5078);
function getLatestSemVersionedTagFactory(params) {
    ...
    function getLatestSemVersionedTag(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { listTags } = (0, listTags_1.listTagsFactory)({ octokit });
            try {
                for (var _d = true, _e = __asyncValues(listTags({ owner, repo })), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const tag = _c;
                    let version;
            ...
            return semVersionedTags
                .sort(({ version: vX }, { version: vY }) => SemVer_1.SemVer.compare(vY, vX))[0];
        });
    }
    ;
...
module.exports = __toCommonJS(dist_src_exports);
var import_core = __nccwpck_require__(4077);
